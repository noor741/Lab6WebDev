...
function recalculate() {
    ...
    var totalCost;
    if(carModelName == "XYZ"){
        totalCost = rentalDuration * 100;
    }
    else if(carModelName == "CPRG"){
        totalCost = rentalDuration * 213;    
    }
...
function changeDuration(){
    ...
    if (newDuration !== null && !isNaN(newDuration)) {
        rentalDuration = parseFloat(newDuration);
        durationText.innerHTML = rentalDuration;
        recalculate();
    } else {
